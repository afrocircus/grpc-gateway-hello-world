# Edited from from
# https://github.com/grpc/grpc/blob/v1.41.0/examples/python/helloworld/async_greeter_server_with_graceful_shutdown.py
...
import grpc
from proto.helloworld import hello_world_pb2
from proto.helloworld import hello_world_pb2_grpc
...
class Greeter(hello_world_pb2_grpc.GreeterServicer):
    ...
    async def SayHello(
            ...
            context: grpc.aio.ServicerContext) -> hello_world_pb2.HelloReply:
